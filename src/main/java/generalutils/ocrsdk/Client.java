...
public class Client {
	...
	public Task processRemoteImage( String fileUrl, ProcessingSettings settings)
			throws Exception {
		URL url = new URL(String.format("%s/processRemoteImage?source=%s&%s", serverUrl, URLEncoder.encode(fileUrl, "UTF-8"), settings.asUrlParams()));
